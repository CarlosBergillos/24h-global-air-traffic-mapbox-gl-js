...
import {customRasterUniformValues} from './program/custom_raster_program.js';
...
function drawCustomRaster(painter: Painter, sourceCache: SourceCache, layer: CustomRasterStyleLayer, tileIDs: Array<OverscaledTileID>, variableOffsets: any, isInitialLoad: boolean) {
    ...
    for (const coord of coords) {
        ...
        const uniformValues = customRasterUniformValues(projMatrix, parentTL || [0, 0], parentScaleBy || 1, fade, layer, perspectiveTransform, zoom);
